(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.run = function(fps, callback) {
      ...
      time = ((_ref = this.oldFrame) != null ? _ref.time : void 0) || 0;
    ...
    Client.prototype.predict = function(snap, commands) {
      ...
      if (snap.players[this.localPlayer.name]) {
        this.localPlayer.position = snap.players[this.localPlayer.name].position;
        this.localPlayer.velocity = snap.players[this.localPlayer.name].velocity;
